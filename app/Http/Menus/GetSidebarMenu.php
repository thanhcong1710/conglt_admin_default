...
class GetSidebarMenu implements MenuInterface
{
    ...
    private function getMenuFromDB($menuName, $arr_role)
    {
        $this->menu = Menus::join('menu_role', 'menus.id', '=', 'menu_role.menus_id')
            ...
            ->whereIn('menu_role.role_name', $arr_role)
    ...
    private function getUserMenu($menuName, $arr_role)
    {
        $this->getMenuFromDB($menuName, $arr_role);
    }
