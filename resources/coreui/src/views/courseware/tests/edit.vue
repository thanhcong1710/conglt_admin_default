      ...
      <div class="col-sm-6">
        <div class="card">
          ...
          <div class="card-header">
            <strong>Cập nhật bài kiểm tra</strong>
          </div>
          <div class="card-body">
...
export default {
  ...
  created() {
    this.loading.processing = true;
     u.g("/api/courses/get_all")
      ...
      .catch((e) => {});
    this.loading.processing = true;
    u.g(`api/tests/detail/${this.$route.params.id}`)
      .then((response) => {
        this.loading.processing = false;
  ...
  methods: {
    save() {
      ...
      u.p(`/api/tests/update/${this.$route.params.id}`, this.test)
        .then((response) => {
          this.loading.processing = false;
          if (response.status == 200) {
            this.modal.color = "success";
            this.modal.body = "Cập nhật bài kiểm tra thành công";
