      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-footer">
            <router-link class="btn btn-sm btn-success" :to="'/tests/add'">
...
export default {
  ...
  methods: {
    ...
    search(a) {
      ...
      const link =
        "/api/tests/list?token=" + localStorage.getItem("api_token");
    ...
    deleteItem(id) {
      u.g(`/api/tests/delete/${id}`)
        .then((response) => {
          this.loading.processing = false;
          if (response.status == 200) {
            this.modal.color = "success";
            this.modal.body = "Xóa bài kiểm tra thành công";
