      ...
      <div class="col-sm-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action method="post">
              <div class="form-group">
                <label for="nf-email">Tên khóa học</label>
                <input
                  class="form-control"
                  type="text"
                  name="title"
          ...
          <div class="card-footer">
            <router-link class="btn btn-danger" :to="`/courses`">
...
export default {
  ...
  created() {
    ...
    u.g(`api/courses/detail/${this.$route.params.id}`)
      .then((response) => {
  ...
  methods: {
    save() {
      ...
      u.p(`/api/courses/update/${this.$route.params.id}`, this.course)
        .then((response) => {
          this.loading.processing = false;
          if (response.status == 200) {
            this.modal.color = "success";
            this.modal.body = "Cập nhật khóa học thành công";
