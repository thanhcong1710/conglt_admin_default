...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      quizs: [],
      pagination: {
        url: "/api/courseware/quizs/list?token=" + localStorage.getItem("api_token"),
        id: "",
        style: "line",
        "class": "",
        spage: 1,
