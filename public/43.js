...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      branches: [],
      pagination: {
        url: "/api/config/branches/list?token=" + localStorage.getItem("api_token"),
        id: "",
        style: "line",
        "class": "",
        spage: 1,
  ...
  methods: {
    ...
    deleteItem: function deleteItem(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/config/branches/delete/".concat(id, "?token=") + localStorage.getItem("api_token")).then(function (response) {
